export const REPORT_NOTE = `#graphql
  mutation ReportNote(
    $malfratId: String!
    $parkourId: Float!
    $commentaire: String!
...
export const DELETE_NOTE_AND_REPORT = `#graphql
...
export const DELETE_NOTE_AND_CREATE_REPORT = `#graphql
...
export const DELETE_USER_BY_ADMIN = `#graphql
