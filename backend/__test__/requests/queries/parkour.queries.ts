export const GET_PARKOUR_BY_ID = `#graphql
...
export const GET_ALL_PARKOUR_FOR_MAP = `#graphql
...
export const GET_TOP20_PARKOUR_BY_TITLE = `#graphql
...
export const GET_TOP20_PARKOUR_BY_SEARCH = `#graphql
...
export const GET_THE_PARKOUR_TOTAL = `#graphql
