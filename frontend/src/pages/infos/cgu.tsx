  ...
  return (
    <main className="pagesInfos">
      ...
      <p>
        ...
        du site et des services par sportParkourCorp et de définir les
        ...
        chaque utilisateur accepte expressément les présentes CGU en cochant la
        case précédant le texte suivant : « Je reconnais avoir lu et compris les
        CGU et je les accepte ». En cas de non-acceptation des CGU stipulées
        dans le présent contrat, l'Utilisateur se doit de renoncer à l'accès des
        services proposés par le site. parkour.com se réserve le droit de
        modifier unilatéralement et à tout moment le contenu des présentes CGU.
      </p>

      <h3>ARTICLE 1 : LES MENTIONS LÉGALES</h3>
      <p>
        L’édition et la direction de la publication du site parkour.com est
        assurée par Baptiste Courtin.
      </p>
      <ul>
      ...
      <p>
        Le site parkour.com permet à l'Utilisateur un accès gratuit aux services
        suivants :
      </p>
      <ul>
      ...
      <p>
        ...
        l'aide de son identifiant et de son mot de passe utilisés lors de sa
      ...
      <p>
        Les sources des informations diffusées sur le site parkour.com sont
        ...
        Malgré des mises à jour régulières, le site parkour.com ne peut être
        ...
        passe. Le site décline toute responsabilité. Le site parkour.com ne peut
      ...
      <p>
        ...
        parkour.com. Ce dernier n’a pas de contrôle sur les pages web sur
      ...
      <p>
        ...
        nécessaires à l’utilisation du site parkour.com.
        <br />
        ...
        site parkour.com. En naviguant sur le site, L’Utilisateur les accepte.
